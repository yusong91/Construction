            ...
            @if(count($maintenances))
                @foreach($maintenances  as $item)
                    <tr>
                        ...
                        <td class="text-center align-middle" style="width: 500px;"><img src="{{ getUrl($item->image_broken) ?? url('assets/img/no_photo.png') }}" width="100"></td>
                        <td class="text-center align-middle" style="width: 500px;"><img src="{{ getUrl($item->image_replace) ?? url('assets/img/no_photo.png') }}" width="100"></td>   
