                ...
                @if(count($maintenances))
                    ...
                    @foreach($maintenances  as $item)
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle"><img src="{{ url('assets/img/old.jpg') }}" width="100"></td>
                            <td class="text-center align-middle"><img src="{{ url('assets/img/new.jpg') }}" width="100"></td>
                            ...
                            <td class="align-middle">
                                ...
                                <a href="{{ route('maintenance.destroy', $item->id) }}" class="btn btn-icon" data-action="" title="Delete" data-toggle="tooltip" data-placement="top" data-method="DELETE"
