            ...
            @for($i = 1; $i <= 1; $i++)
                    <tr>
                        ...
                        <td>
                            <div class="form-floating">
                                <div class="custom-file" >
                                    <input type="file" class="custom-file-input" id="file_broken{{$i}}" name="image_broken" style="width: 350px;">
                        ...
                        <td>
                            <div class="form-floating">
                                <div class="custom-file" >
                                    <input type="file" class="custom-file-input" id="file_replacement{{$i}}" name="image_replace" style="width: 350px;">
