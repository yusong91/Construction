    ...
    <table class="table table-bordered">
        ...
        <tbody>  
            <tr>
                ...
                <td>
                    <div id="service_name">
                        <input type="text" class="form-control form-borderless" name="service_name" id="service_name" style="width: 250px;" value="{{ $edit->service ?? '' }}">
                    </div>
                ...
                <td>
                    <div class="form-floating">
                        <input type="text" class="form-control form-borderless" name="date" id="a_date" style="width: 130px;" value="{{ getDateFormat($edit->date) }}">
                    </div>
                </td> 
