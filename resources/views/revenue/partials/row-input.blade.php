    ...
    <tbody> 
        ...
        @for($i = 1; $i <= 8; $i++)
            ...
            <tr>
                ...
                <td>
                    <select class="form-control js-example-responsive"  name="{{$i}}customer_id" data-live-search="true" style="width: 250px;">    
                ...
                <td>
                    <div class="form-floating">
                        <input type="number" class="form-control" name="{{$i}}work_day" style="width: 120px;">
                    </div>
                </td>
                <td>
                    <div class="form-floating">
                        <input type="text" class="form-control" name="{{$i}}rental_price" style="width: 120px;">
                    </div>
                </td>
