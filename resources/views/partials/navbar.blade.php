<nav class="navbar navbar-expand-lg navbar-light fixed-top pl-0 pr-0 py-0" >
   ...
   <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand" href="{{ url('/') }}">
            ...
            <img src="{{ url('assets/img/logo.png') }}" class="logo-sm" height="35" alt="{{ setting('app_name') }}">
        </a>
    </div>
    ...
    <div class="nav-item collapse navbar-collapse" id="top-navigation"> 
        ...
        <ul class="navbar-nav ml-auto pr-4 flex-row"> 
            ...
            <li class="nav-item d-flex align-items-center visible-lg">
                <a class="nav-link {{ Request::is('/') ? 'active' : ''  }}"  href="{{ route('dashboard') }}"><h5 class="header mb-0">Dashboard</h5></a>
            </li>
            ...
            <li class="nav-item d-flex align-items-center visible-lg">
                <a class="nav-link {{ Request::is('transaction*', 'equipmentsold*', 'movement*', 'revenue*', 'maintenance*') ? 'active' : ''  }}"  href="{{ route('transaction.index') }}"><h5 class="header mb-0">Transactions</h5></a>
            </li>
