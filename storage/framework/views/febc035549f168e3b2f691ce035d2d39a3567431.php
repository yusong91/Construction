<form action="<?php echo e(route('equipment.store')); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8" autocomplete="off">
    ...
    <fieldset class="border p-2 " style="overflow-x: scroll;">
        ...
        <?php echo $__env->make('equipment.partials.row', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
...
<?php /**PATH /Users/yusonghoun/Web Software/construction/resources/views/equipment/partials/input-form.blade.php ENDPATH**/ ?>