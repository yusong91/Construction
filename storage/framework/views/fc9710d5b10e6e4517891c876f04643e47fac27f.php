...
<div class="card">
    <div class="card-body">
                ...
                <div class="float-right">
                    <div class="row">
                        <div class="col-xl-5 col-md-5">
                            <a href="<?php echo e(route('transaction.create')); ?>" class="btn btn-primary" style="width: 100px;" >+ Sold</a>
                        </div> 
                    </div> 
                </div>      
            </div>
        ...
        <?php echo $__env->make('equipment-sold.partials.row', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.main_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusonghoun/Web Software/construction/resources/views/equipment-sold/index.blade.php ENDPATH**/ ?>