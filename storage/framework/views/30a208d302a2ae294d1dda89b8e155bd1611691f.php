    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('report-equipment.store')); ?>" id="user-form" method="POST" accept-charset="UTF-8">
            ...
            <legend>Report</legend> 
                ...
                <?php echo $__env->make('report.equipment-report.partials.row-result', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </fieldset>
            <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('layouts.main_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusonghoun/Web Software/construction/resources/views/report/equipment-report/result.blade.php ENDPATH**/ ?>