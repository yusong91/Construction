    ...
    <div class="col-md-6">
        <table class="table tbl-info table-light shadow"  style="height: 300px;">
            <thead class="bg-primary">
                <tr>
                    <th>
                    <?php echo app('translator')->get('Data_patient_4_day_later'); ?>
                    </th>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="col-md-6">
        <table class="table tbl-info table-light shadow"  style="height: 300px;">
            <thead class="bg-primary">
                <tr>
                    <th>
                    <?php echo app('translator')->get('Data_patient_dialy'); ?>
                    </th>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="col-md-6">
        <table class="table tbl-info table-light shadow"  style="height: 300px;">
            <thead class="bg-primary">
                <tr>
                    <th>
                        <?php echo app('translator')->get('total_gender_title'); ?> ( 10 )
                    </th>
                </tr>
            </thead>
                <tbody>
...
<?php echo $__env->make('layouts.main_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusonghoun/Web Software/construction/resources/views/dashboard/index.blade.php ENDPATH**/ ?>